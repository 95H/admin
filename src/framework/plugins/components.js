...
export default {
    install: function(Vue) {
        ...
        Vue.prototype.formatDate = function(date) {
            return basicutils.formatDateByPattern(new Date(date), 'yyyy-MM-dd HH:mm:ss')
        }

        Vue.prototype.formatDateByPattern = function(date, pattern) {
            return basicutils.formatDateByPattern(new Date(date), pattern)
        }
